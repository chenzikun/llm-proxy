...
func CountTokenMessages(messages []entity.Message, model string) int {
...
// PredictChatPromptTokenCount 预测对话任务中提示词的token数量
func PredictChatPromptTokenCount(textRequest *entity.GeneralOpenAIRequest, relayMode int) int {
	switch relayMode {
