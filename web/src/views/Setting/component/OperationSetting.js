  ...
  const submitConfig = async (group) => {
    switch (group) {
      ...
      case "ratio":
        ...
        if (originInputs["ExchangeRate"] !== String(inputs.ExchangeRate)) {
          await updateOption("ExchangeRate", String(inputs.ExchangeRate));
        }
        break;
      case "quota":
    ...
    <Stack spacing={2}>
          ...
          >
            ...
            <FormControl fullWidth>
              ...
              <OutlinedInput
                ...
                onChange={handleInputChange}
                label="单位额度"
                placeholder="1 元人民币（¥）能兑换的额度，默认 1000000"
                disabled={loading}
              />
            </FormControl>
            <FormControl fullWidth>
      ...
      <SubCard title="倍率与汇率设置">
        <Stack justifyContent="flex-start" alignItems="flex-start" spacing={2}>
          ...
          >
            <FormControl fullWidth>
              <InputLabel htmlFor="ExchangeRate">美元汇率（USD → CNY）</InputLabel>
              <OutlinedInput
                id="ExchangeRate"
                name="ExchangeRate"
                type="number"
                ...
                onChange={handleInputChange}
                label="美元汇率（USD → CNY）"
                placeholder="例如：7.2，表示 1 USD = 7.2 CNY"
                disabled={loading}
