...
func ConvertRequest(request entity.GeneralOpenAIRequest) *LibraryRequest {
	query := ""
...
func Handler(c *gin.Context, resp *http.Response) (*objects.ErrorWithStatusCode, *entity.Usage) {
	...
	if err != nil {
		return objects.ErrorWrapper(err, "write_response_body_failed", http.StatusInternalServerError), nil
	}
