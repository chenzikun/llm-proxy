...
func ConvertRequest(textRequest entity.GeneralOpenAIRequest) *ChatRequest {
	...
	if textRequest.Tools != nil {
		functions := make([]entity.Function, 0, len(textRequest.Tools))
...
func ConvertEmbeddingRequest(request entity.GeneralOpenAIRequest) *BatchEmbeddingRequest {
...
func getToolCalls(candidate *ChatCandidate) []entity.Tool {
...
func Handler(c *gin.Context, resp *http.Response, promptTokens int, modelName string) (*objects.ErrorWithStatusCode, *entity.Usage) {
	...
	completionTokens := objects.CountTokenText(geminiResponse.GetResponseText(), modelName)
	usage := entity.Usage{
