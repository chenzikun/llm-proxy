...
var ModelRatio = map[string]float64{
	...
	"chatgpt-4o-latest":          1.25,  // $0.0025 / 1K tokens
	"gpt-4o-2024-05-13":          1.25,  // $0.0025 / 1K tokens
	"gpt-4o-2024-08-06":          1.25,  // $0.0025 / 1K tokens
	"gpt-4o-mini":                0.075, // $0.00015 / 1K tokens
	"gpt-4o-mini-2024-07-18":     0.075, // $0.00015 / 1K tokens
	"gpt-4.5-preview":            37.5,  // $0.075 / 1K tokens
	"gpt-4.5-preview-2025-02-27": 37.5,  // $0.075 / 1K tokens
	...
	"o1-2024-12-17":              7.5,
	"o3-mini":                    0.55, // $0.0011 / 1K tokens
	"o3-mini-2025-01-31":         0.55, // $0.0011 / 1K tokens
	...
	// 自有模型
	"Endpoint-csms":        0,
	"Endpoint-app-english": 0,
	"enedev-20250210-app-english-202502100453-endpoint": 0,
	"app-csms-202502100453-endpoint":                    0,
	"app-csms-202502280849-endpoint":                    0,
	"app-csms-202503060546-endpoint":                    0,
	"app-csms-202503100347-endpoint":                    0,
	"app-csms-202503140159-endpoint":                    0,
	// https://www.anthropic.com/api#pricing
	"aws-claude3:haiku-20240307":                0.00025 * USD,
	"aws-claude3.5:haiku-20241022":              0.001 * USD,
	"aws-claude3:sonnet-20240229":               0.003 * USD,
	"aws-claude3.5:sonnet-20240620":             0.003 * USD,
	"aws-claude3.5:sonnet-20241022":             0.003 * USD,
	"aws-claude3:opus-20240229":                 0.015 * USD,
	"claude-3-5-sonnet-20241022":                0.003 * USD,
	"anthropic.claude-3-5-sonnet-20241022-v2:0": 0.003 * USD,
	"anthropic.claude-3-5-sonnet-20240620-v1:0": 0.003 * USD,
	"anthropic.claude-3-haiku-20240307-v1:0":    0.00025 * USD,
	"anthropic.claude-3-sonnet-20240229-v1:0":   0.003 * USD,
	"anthropic.claude-3-opus-20240229-v1:0":     0.015 * USD,
	"anthropic.claude-3-5-haiku-20241022-v1:0":  0.001 * USD,

	"claude-3-7-sonnet-20250219":                0.003 * USD,
	"aws-claude3.7:sonnet-20250219":             0.003 * USD,
	"anthropic.claude-3-7-sonnet-20250219-v1:0": 0.003 * USD,

	// https://aws.amazon.com/bedrock/pricing/
	// aws llama3 https://aws.amazon.com/cn/bedrock/pricing/
	"aws-llama3:8b":  0.0003 * USD,  // $0.0003 / 1K tokens
	"aws-llama3:70b": 0.00265 * USD, // $0.00265 / 1K tokens

	"aws-llama3.1:8b":   0.00022 * USD,
	"aws-llama3.1:70b":  0.00099 * USD,
	"aws-llama3.1:405b": 0.00532 * USD,

	"aws-llama3.2:1b":  0.0001 * USD,
	"aws-llama3.2:3b":  0.00015 * USD,
	"aws-llama3.2:11b": 0.00035 * USD,
	"aws-llama3.2:90b": 0.002 * USD,

	"meta.llama3-8b-instruct-v1:0":  0.0003 * USD,
	"meta.llama3-70b-instruct-v1:0": 0.00265 * USD,

	"meta.llama3-1-8b-instruct-v1:0":   0.00022 * USD,
	"meta.llama3-1-70b-instruct-v1:0":  0.00099 * USD,
	"meta.llama3-1-405b-instruct-v1:0": 0.00532 * USD,

	"meta.llama3-2-1b-instruct-v1:0":  0.0001 * USD,
	"meta.llama3-2-3b-instruct-v1:0":  0.00015 * USD,
	"meta.llama3-2-11b-instruct-v1:0": 0.00035 * USD,
	"meta.llama3-2-90b-instruct-v1:0": 0.002 * USD,

	"deepseek.r1-v1:0": 0.00135 * USD,

	// embed 模型和 rerank 模型，input收费，output不收费
	"cohere.embed-english-v3":      0.0001 * USD,
	"cohere.embed-multilingual-v3": 0.0001 * USD,
	"amazon.titan-embed-text-v1":   0.0001 * USD,
	...
	"wanx-v1":                   8,
	"deepseek-ai/DeepSeek-V3":   0.002 * RMB,
	"deepseek-ai/DeepSeek-R1":   0.004 * RMB,
	...
	"deepseek-chat":     2.0 / 1000 * RMB,
	"deepseek-coder":    1.0 / 1000 * RMB,
	"deepseek-reasoner": 4.0 / 1000 * RMB,
...
// FineTuningRatio 微调费率，单位为 1k tokens
var FineTuningRatio = map[string]float64{
	// https://openai.com/api/pricing/
	"gpt-3.5-turbo":          0.008 * USD,
	"gpt-4o-2024-08-06":      0.025 * USD,
	"gpt-4o-mini-2024-07-18": 0.003 * USD,
}
...
func GetCompletionRatio(name string, channelType int) float64 {
	...
	if strings.HasPrefix(name, "aws-llama3.2") {
		return 1
	}
	if strings.HasPrefix(name, "meta.llama3-2") {
		return 1
	}
	if strings.HasPrefix(name, "meta.llama3-1") {
		return 1
	}
	if strings.HasPrefix(name, "meta.llama3") {
		return 2
	}
	if strings.HasPrefix(name, "aws-claude3") {
		return 5
	}
	if strings.HasPrefix(name, "claude-3") {
		return 5
	}
	if strings.HasPrefix(name, "anthropic.claude-3") {
		return 5
	}
	if strings.HasPrefix(name, "claude-3") {
		return 5
