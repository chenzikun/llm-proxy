...
import (
	...
	"github.com/zicorn/llm-proxy/pkg/common/blacklist"
...
type User struct {
	...
	AffCode          string `json:"aff_code" gorm:"type:varchar(32);column:aff_code;uniqueIndex"` // this code is the inviter's code, not the user's own code
	InviterId        int    `json:"inviter_id" gorm:"type:int;column:inviter_id;index"`           // inviter's id
}
