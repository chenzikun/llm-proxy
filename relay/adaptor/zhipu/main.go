...
func ConvertRequest(request entity.GeneralOpenAIRequest) *Request {
...
func streamMetaResponseZhipu2OpenAI(zhipuResponse *StreamMetaResponse) (*openai.ChatCompletionsStreamResponse, *entity.Usage) {
	var choice openai.ChatCompletionsStreamResponseChoice
...
func EmbeddingsHandler(c *gin.Context, resp *http.Response) (*objects.ErrorWithStatusCode, *entity.Usage) {
