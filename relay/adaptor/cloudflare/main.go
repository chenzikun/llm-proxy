...
func ConvertCompletionsRequest(textRequest entity.GeneralOpenAIRequest) *Request {
...
func StreamHandler(c *gin.Context, resp *http.Response, promptTokens int, modelName string) (*objects.ErrorWithStatusCode, *entity.Usage) {
