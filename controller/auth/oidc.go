...
func getOidcUserInfoByCode(code string) (*OidcUser, error) {
	...
	data.Set("code", code)
	data.Set("redirect_uri", fmt.Sprintf("%s/oauth/oidc", config.ServerAddress))
	req, err := http.NewRequest("POST", config.OidcTokenEndpoint, bytes.NewBufferString(data.Encode()))
	if err != nil {
		return nil, err
	}
